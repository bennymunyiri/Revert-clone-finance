...
contract V3UtilsIntegrationTest is Test {
    ...
    address constant DAI_WHALE_ACCOUNT =
    ...
    function testSwapAndMintPermit2() public {
        ...
        ISignatureTransfer.TokenPermissions[]
            memory permissions = new ISignatureTransfer.TokenPermissions[](2);
        ...
        ISignatureTransfer.PermitBatchTransferFrom
            memory tf = ISignatureTransfer.PermitBatchTransferFrom(
                permissions,
                1,
                block.timestamp
            );

        bytes memory signature = _getPermitBatchTransferFromSignature(
            tf,
            privateKey,
            address(v3utils)
        );
